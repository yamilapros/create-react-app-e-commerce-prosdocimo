...
const CartWidget = () => {
    const { cartList, totalToPay } = useContext(CartContext)
    ...
    return (
        ...
        }
        {
            cartList.length === 0
            ?
            <span className="cart-price-info">0&euro;</span>
            :
            <span className="cart-price-info">{totalToPay()}&euro;</span>
        }
